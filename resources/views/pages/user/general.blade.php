...
<div class="container mt-4 px-0">
    ...
    <form method="POST" action="/user/edit" enctype="multipart/form-data">
        ...
        <div class="row mx-auto mt-4">
            <label for="username" class="control-label text-light px-0  col-5">Display Name</label>
        </div>

        <div class="row mt-2 mx-auto">
            <input type="text" name="username" class="form-control col-5 text-field my-auto  bg-secondary text-light"
                style="height:50px" minlength="1" maxlength="60" placeholder="*Display Name"
                value="{{Auth::user()->username ?? null}}" required>
        </div>
        ...
        <div class="row mx-auto mt-4">
            <label for="first_name" class="control-label text-light px-0 col-5">First Name</label>

            <div class="col-1"></div>
            <label for="last_name" class="control-label text-light px-0  col-5">Last Name</label>
        </div>

        <div class="row mt-2 mx-auto">
            <input type="text" name="first_name" class="form-control col-5 text-field my-auto  bg-secondary text-light"
                style="height:50px" minlength="1" maxlength="60" placeholder="*First Name"
                value="{{Auth::user()->first_name ?? null}}" required>

            <div class="col-1"></div>

            <input type="text" name="last_name" class="form-control col-5 text-field my-auto  bg-secondary text-light"
                style="height:50px" minlength="1" maxlength="60" placeholder="*Last Name"
                value="{{Auth::user()->last_name ?? null}}" required>
        </div>
        ...
        <div class="row mx-auto mt-4">
            <label for="description" class="control-label col-5 px-0  text-light">Description</label>
            <div class="col-1"></div>
            <label for="nif" class="control-label col-5 px-0  text-light">NIF</label>
        </div>

        <div class="row mt-2 mx-auto ">
            <input type="text" name="description" class="form-control col-5 text-field my-auto  bg-secondary text-light"
                style="height:50px" maxlength="500" placeholder="Add a Description"
                value="{{Auth::user()->description ?? null}}">
        ...
        <div class="row mx-auto mt-4">
            <label for="line1" class="control-label text-light px-0  col-5">Address Line 1</label>
            <div class="col-1"></div>
            <label for="line2" class="control-label text-light px-0  col-5">Address Line 2</label>
        </div>
        ...
        <div class="row mt-2 mx-auto">
            ...
            <input type="text" name="line2" class="form-control col-5 bg-secondary text-white" style="height:50px"
                minlength="1" maxlength="100" placeholder="Address Line 2"
                value="{{Auth::user()->address->line2 ?? null}}">
        </div>
        ...
        <div class="row mx-auto mt-4">
            <label for="city" class="control-label text-light px-0  col-5">City</label>
            <div class="col-1"></div>
            <label for="region" class="control-label text-light px-0  col-2">Region</label>
            <label for="postal_code" class="control-label text-light px-0  col-3">Postal Code</label>
        </div>
        ...
        <div class="row mx-auto mt-4">
            <label for="country" class="control-label col-5 px-0  text-light">Country</label>
        </div>

        <div class="row mx-auto ">
            <select name="country" class="form-control col-5 bg-secondary text-white" style="height:50px">
