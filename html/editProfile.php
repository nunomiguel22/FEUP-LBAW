                            ...
                            <form>
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small id="descriptionHelp" class="form-text text-muted">Publicly available.</small>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputFile">Profile Picture</label>
                                        <input type="file" class="form-control-file" id="profilePicture" aria-describedby="fileHelp">
                                        <small id="fileHelp" class="form-text text-muted">Please use a valid image. PNG and JPEG accepted.</small>
                                    </div>
