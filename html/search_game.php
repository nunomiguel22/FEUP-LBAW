    ...
    <div class="row row-cols-1 row-cols-md-3 mt-3">
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row card-main-info">
              <h4 class="card-title col-sm-7">Cyberpunk 2077</h4>
              <h5 class="card-text col-sm-5">59.99€</h5>
            </div>
      ...
      <div class="col mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row card-main-info">
              <h4 class="card-title col-sm-7">Outriders</h4>
              <h5 class="card-text col-sm-5">40.00€</h5>
            </div>
      ...
      <div class="col mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row card-main-info">
              <h4 class="card-title col-sm-7">Hitman 3</h4>
              <h5 class="card-text col-sm-5">30.00€</h5>
            </div>
      ...
      <div class="col mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row card-main-info">
              <h4 class="card-title col-sm-7">Grand Theft Auto V</h4>
              <h5 class="card-text col-sm-5">20.99€</h5>
            </div>
      ...
      <div class="col mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row card-main-info">
              <h4 class="card-title col-sm-7">Counter Strike: Global Offensive</h4>
              <h5 class="card-text col-sm-5">40.00€</h5>
            </div>
      ...
      <div class="col mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row card-main-info">
              <h4 class="card-title col-sm-7">Control</h4>
              <h5 class="card-text col-sm-5">29.99€</h5>
            </div>
      ...
      <div class="col mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row card-main-info">
              <h4 class="card-title col-sm-7">Ghostrunner</h4>
      ...
      <div class="col mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row card-main-info">
              <h4 class="card-title col-sm-7">Borderlands 3</h4>
      ...
      <div class="col mb-4">
        <div class="card h-100">
          ...
          <div class="card-body">
            <div class="row card-main-info">
              <h4 class="card-title col-sm-7">Call of Duty: Modern Warfare 3</h4>
